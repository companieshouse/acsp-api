...
public enum AMLSupervisoryBodies {
    ACCA("Association of Chartered Certified Accountants (ACCA)","association-of-chartered-certified-accountants (ACCA)"),
    AAT("Association of Accounting Technicians (AAT)","association-of-accounting-technicians (AAT)"),
    AIA( "Association of International Accountants (AIA)","association-of-international-accountants (AIA)");
