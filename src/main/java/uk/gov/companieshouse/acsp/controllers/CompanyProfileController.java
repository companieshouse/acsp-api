...
public class CompanyProfileController {
    ...
    public ResponseEntity<Object> getCompany(@PathVariable String id, HttpServletRequest request){
       try{
           var companyUri = GET_COMPANY_URI.expand(id.toUpperCase()).toString();
